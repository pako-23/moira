...
public class DefaultServiceIsIndependentTest extends DefaultServiceTest {
  ...
  public void testIdependentPairs() {
    ...
    assertThat(
        executions[0].getArguments(), hasItem(moira.service.ScheduleExecutor.class.getName()));
    assertThat(
        executions[1].getArguments(), hasItem(moira.service.ScheduleExecutor.class.getName()));
  }
