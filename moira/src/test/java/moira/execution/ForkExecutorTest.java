...
public class ForkExecutorTest {
  ...
  public void testSimpleExecution() throws IOException, InterruptedException {
    ...
    new ForkExecutor(processFactory).execution().withArguments("moira.execution.Example").exec();
    assertCommand("moira.execution.Example");
  }
  ...
  public void testSetClassPathUpdatesTheClassPath(final String classpath)
    ...
    executor.execution().withArguments("moira.execution.Example").exec();
  ...
  public void testSetArgumentsMultipleTimes() throws IOException, InterruptedException {
    ...
    new ForkExecutor(processFactory)
        .execution()
        .withArguments("moira.execution.Example")
        .withArguments("moira.execution.SomeOtherClass")
        .exec();
    assertCommand("moira.execution.SomeOtherClass");
  }
  ...
  public void testMultipleArguemnts() throws IOException, InterruptedException {
    ...
    new ForkExecutor(processFactory)
        .execution()
        .withArguments("moira.execution.Example", "--output", "somefile")
        .exec();

    assertCommand("moira.execution.Example", "--output", "somefile");
  }

  @Test
  public void testFailedProcessExecution() throws IOException, InterruptedException {
    final Execution execution =
        new ForkExecutor(processFactory).execution().withArguments("moira.execution.Example");
  ...
  public void testStdoutProcessing() throws IOException, InterruptedException {
    ...
    new ForkExecutor(processFactory)
        .execution()
        .withArguments("moira.execution.HelloWorld")
        .withStdOut(buffer::append)
        .exec();

    assertCommand("moira.execution.HelloWorld");
  ...
  public void testStdoutAndStderrOutput() throws IOException, InterruptedException {
    ...
    new ForkExecutor(processFactory)
        .execution()
        .withArguments("moira.execution.RandomStrings")
        .withStdErr(line -> stderr.append(line + '\n'))
        .withStdOut(line -> stdout.append(line + '\n'))
        .exec();

    assertCommand("moira.execution.RandomStrings");
  ...
  public void testEchoMixedStdoutStderrOutput() {
    ...
    new ForkExecutor()
        .execution()
        .withArguments("moira.execution.MixedOutput")
        .withStdErr(line -> stderr.append(line + '\n'))
        .withStdOut(line -> stdout.append(line + '\n'))
  ...
  public void testNotExistingClass() {
    final Execution execution =
        new ForkExecutor().execution().withArguments("moira.execution.NotExistingClass");
    final RuntimeException exception = assertThrows(RuntimeException.class, execution::exec);
