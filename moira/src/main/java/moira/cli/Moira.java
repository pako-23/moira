...
import moira.factory.DefaultFactory;
...
public class Moira implements Callable<Integer> {
  ...
  public Moira(final MoiraFactory factory) {
  ...
  public static void main(final String... args) {
    final Moira moira = new Moira(new DefaultFactory());
