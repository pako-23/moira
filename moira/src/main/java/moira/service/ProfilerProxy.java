...
public class ProfilerProxy {
  ...
  public ProfilerProxy(final String profiler)
    ...
    dump =
        lookup.findStatic(
            profilerClass, "dump", MethodType.methodType(void.class, PrintStream.class));
  }
  ...
  public void dump(final PrintStream stream) {
    try {
      dump.invokeExact(stream);
    } catch (final Throwable e) {
      throw new RuntimeException("Failed to invoke profiler at dump", e);
    }
  }
}
